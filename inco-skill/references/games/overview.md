...
- [frontend.md](frontend.md) — read this when wiring the UI: the encrypt → tx → reveal → paint loop, cached attestations, one-popup UX, the optional allowance voucher for popup-free private decryption (cards/roles), and multiplier parity.
